...
use crate::models::layout::{Layout, Screen, State};
use crate::models::monitor::Monitor;
use crate::models::resolution::Resolution;
use crate::models::workspace::Workspace;

use super::Compositorctl;
...
fn hyprctl(args: &[&str]) -> Result<String> {
    ...
    if !output.status.success() || stdout.starts_with("Couldn't open a socket") {
        ...
        bail!("hyprctl {} failed: {detail}", args.join(" "));
    }
    Ok(stdout)
}
...
mod tests {
    use super::*;
    use crate::models::layout::fixtures::{laptop, ultrawide, BOE, DELL, LG};
    use crate::models::layout::{Placement, Screen};
