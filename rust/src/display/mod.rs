...
use crate::backend::notifier::Notifierctl;
use crate::error::AppError;
use crate::models::layout::{Direction, Layout, Mode, Scale, Side};
use crate::models::monitor::Monitor;
use crate::models::resolution::{Resolution, Size};
...
mod tests {
    use super::*;
    use crate::backend::compositor::backend;
    use crate::models::layout::fixtures::{laptop, switched_off, ultrawide, BOE, LG};
